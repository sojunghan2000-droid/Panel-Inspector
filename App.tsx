    ...
    <div className="flex h-screen min-h-[100dvh] bg-slate-50 text-slate-800 overflow-hidden font-sans">
      ...
      `}>
        <div className="p-6 border-b border-slate-800 flex items-center gap-3">
          ...
          <h1 className="font-bold text-lg tracking-tight whitespace-nowrap">성수동 <span className="text-blue-400">K-PJT</span> <span className="text-slate-500 text-sm font-normal">Ver.14</span></h1>
        </div>
